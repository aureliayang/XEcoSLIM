...
class Network2(nn.Module):
    def __init__(self, dim, num_encoder_layers, num_decoder_layers, latent_dim):
        ...
        for i in range(num_encoder_layers):
            if i == 0:
                print(i, 1, int(fc_latent_dim // 2**(num_encoder_layers - i - 1)))
                ...
                print(i, int(fc_latent_dim // 2**(num_encoder_layers - i)), int(fc_latent_dim // 2**(num_encoder_layers - i - 1)))
